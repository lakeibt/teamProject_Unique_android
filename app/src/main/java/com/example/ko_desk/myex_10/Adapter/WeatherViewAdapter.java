...
import com.example.ko_desk.myex_10.WeatherItems;
...
public class WeatherViewAdapter extends BaseAdapter {
    ...
    private int layout;
    public WeatherViewAdapter(Context context, int layout, ArrayList<WeatherItems> data){
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        WeatherItems listviewitem=data.get(position);
        TextView name=(TextView)convertView.findViewById(R.id.weatherItem);
