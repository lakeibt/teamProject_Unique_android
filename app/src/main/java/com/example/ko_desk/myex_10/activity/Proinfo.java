...
public class Proinfo extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.personinfopro);
        ...
        btnInfoSave.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Proinfo.InnerTask2 task = new Proinfo.InnerTask2();
                Map<String, String> map = new HashMap<>();
                map.put("id", id);
        ...
        btnback.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Proinfo.this, MainActivity.class);
...
//        super.onBackPressed();
    ...
    private class InnerTask extends AsyncTask<Map, Integer, String> {
        ...
        protected String doInBackground(Map... maps) {
            HttpClient.Builder http = new HttpClient.Builder("POST", Web.servletURL + "android/proinfo"); //@RequestMapping url
    ...
    private class InnerTask2 extends AsyncTask<Map, Integer, String> {
        ...
        @Override
        protected String doInBackground(Map... maps) {
            HttpClient.Builder http = new HttpClient.Builder("POST", Web.servletURL + "android/proinfosave"); //@RequestMapping url
            http.addAllParameters(maps[0]);
