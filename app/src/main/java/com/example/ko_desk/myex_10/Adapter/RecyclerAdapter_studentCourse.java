...
public class RecyclerAdapter_studentCourse extends RecyclerView.Adapter<RecyclerAdapter_studentCourse.ItemViewHolder> {
    ...
    public ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recyclerview_item_student_course, parent, false);
    ...
    class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        void onBind(Map<String, String> data) {
            ...
            Log.d("professor:", data.get("professor"));
